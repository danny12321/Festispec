...
namespace Festispec.Utils
{
    class RouteDurationCalculator
    {
        public async Task<TimeSpan> CalculateRoute(string start, string end)
        {
            ...
            var jsonString = await client.GetStringAsync($"https://api.openrouteservice.org/v2/directions/driving-car?api_key=5b3ce3597851110001cf6248697761b8fe94467f88694a2d6522692e&start={start}&end={end}").ConfigureAwait(false);
